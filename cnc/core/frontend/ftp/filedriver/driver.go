...
func (driver *FileDriver) Init(conn *server2.Conn) {
...
func (driver *FileDriver) Stat(path string) (server2.FileInfo, error) {
...
func (driver *FileDriver) ListDir(path string, callback func(server2.FileInfo) error) error {
	basepath := driver.realPath(path)
...
func (factory *FileDriverFactory) NewDriver() (server2.Driver, error) {
